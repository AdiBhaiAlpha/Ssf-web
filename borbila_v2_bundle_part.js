...
// ============================================================================
// BORBILA PHOTOCARD GENERATOR V2 & MODAL HOST
// ============================================================================
...
function BorbilaPhotoCardV2({ item, db, onClose, isStandalone, onSelectItem, setCurrentTab }) {
  ...
  Q.useEffect(() => {
    ...
    const loadImg = (src) => {
      if (window.borbilaLoadImage) return window.borbilaLoadImage(src);
      return new Promise((res, rej) => {
        ...
        img.onerror = () => {
          const fb = new Image();
          fb.onload = () => res(fb);
          fb.onerror = () => rej(new Error("img error"));
          fb.src = src;
        };
        img.src = src;
      });
    ...
    Promise.all([
      loadImg(payload.imageUrl).catch(() => null),
      payload.logoUrl ? loadImg(payload.logoUrl).catch(() => null) : Promise.resolve(null)
              ...
              i.jsx("div", {
                ...
                children: [
                  ...
                  i.jsxs("button", {
                    ...
                    className: "flex-1 py-3 px-2 text-xs font-semibold flex items-center justify-center gap-1.5 transition border-b-2 whitespace-nowrap cursor-pointer " + (activeTab === tab.id ? "text-rose-400 border-rose-500 bg-slate-900" : "text-slate-400 border-transparent hover:text-slate-200 hover:bg-slate-900/40"),
                    children: [
                      i.jsx("svg", {
                  ...
                  activeTab === "formats" && i.jsxs("div", {
                    ...
                    children: [
                      allArticlesList.length > 0 && i.jsxs("div", {
                        ...
                        children: [
                          i.jsx("label", { className: "text-xs font-bold text-slate-300 flex items-center gap-1.5", children: i.jsx("span", { children: "📰 খবর/পোস্ট থেকে সরাসরি লোড করুন:" }) }),
                          i.jsxs("select", {
                      ...
                      i.jsx("div", {
                        ...
                        children: Object.keys(PRESETS).map(key => {
                          ...
                          return i.jsxs("div", {
                            ...
                            className: "p-3.5 rounded-xl border transition-all cursor-pointer relative flex gap-3.5 items-start " + (isSelected ? "bg-rose-950/20 border-rose-500 shadow-md shadow-rose-950/40 ring-1 ring-rose-500" : "bg-slate-900/60 border-slate-800 hover:border-slate-700 hover:bg-slate-900"),
                            children: [
                              i.jsxs("div", {
          ...
          i.jsxs("div", {
            ...
            children: [
                  ...
                  i.jsx("div", {
                    ...
                    children: [
                      ...
                      i.jsx("button", {
                        ...
                        className: "px-2 py-0.5 text-[11px] font-semibold rounded transition cursor-pointer " + (zoomLevel === z.id ? "bg-rose-600 text-white shadow-xs" : "text-slate-400 hover:text-slate-200"),
                        children: z.label
                      })
                    ))
                  })
              ...
              i.jsx("div", {
                ...
                children: i.jsx("div", {
                  className: "relative shadow-2xl rounded-2xl overflow-hidden border-2 border-slate-800 bg-black transition-all duration-200 " + (zoomLevel === "fit" ? "max-w-[480px] w-full" : zoomLevel === "50" ? "w-[540px]" : zoomLevel === "75" ? "w-[810px]" : "w-[1080px]"),
