// Script to generate complete PressReleaseCreatorComp and inject it into the bundle
const fs = require('fs');
...
fs.writeFileSync('./pr_component_code.js', prComponentCode, 'utf8');
console.log('PressReleaseCreatorComp code generated, length:', prComponentCode.length);
