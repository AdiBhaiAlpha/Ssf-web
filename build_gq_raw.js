...
const gqFileContent = `function GQ({ item: n, onClose: e }) {
  // 1. Core State
        ...
        children: [
          ...
          i.jsxs("div", {
            ...
            children: [
                ...
                children: [
                  ...
                  i.jsx("div", {
                    ...
                    children: [
                      ...
                      className: "flex-1 min-w-[65px] py-2.5 px-2 text-center border-b-2 cursor-pointer transition whitespace-nowrap " + (activeTab === t.id ? "border-rose-600 text-rose-600 bg-white dark:bg-zinc-950 font-black" : "border-transparent text-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-200"),
                      children: t.name
                    }))
                  }),
                  ...
                  i.jsxs("div", {
                    ...
                    children: [
                      ...
                      // TAB 2: TYPOGRAPHY & FONT PREVIEW COMPONENT
                                  ...
                                  i.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      i.jsxs("span", { className: "font-black text-xs text-zinc-800 dark:text-zinc-200", children: [
                                        (layerElements.find(l => l.id === selectedElement)?.name || "উপাদান") + " মুভ করুন"
                                      ]})
                                    ]
                                  }),
                                  i.jsx("span", {
              ...
              // Right Column: Canvas Live Preview & Export Toolbar
              i.jsxs("div", {
...
fs.writeFileSync('gq_replacement.js', gqFileContent, 'utf8');
console.log('Saved gq_replacement.js');
`;

fs.writeFileSync('build_gq_raw.js', gqFileContent, 'utf8');
console.log('Created build_gq_raw.js');
