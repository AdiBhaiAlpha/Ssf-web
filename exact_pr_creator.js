...
function XQ(){const n=Nm(),[e,t]=Q.useState("home"),[s,r]=Q.useState(!1),[a,l]=Q.useState(null),[d,u]=Q.useState(null),[h,p]=Q.useState(null),[m,x]=Q.useState(!0),[b,N]=Q.useState(null),[A,E]=Q.useState(""),[j,F]=Q.useState(!navigator.onLine),[P,L]=Q.useState(null),[Y,X]=Q.useState(!1);Q.useEffect(()=>{const ve=()=>F(!1),ke=()=>F(!0);return window.addEventListener("online",ve),window.addEventListener("offline",ke),()=>{window.removeEventListener("online",ve),window.removeEventListener("offline",ke)}},[]);const U=()=>{if(!h)return[];if(!A.trim())return h.news;const ve=A.toLowerCase();return h.news.filter(ke=>ke.title.toLowerCase().includes(ve)||ke.excerpt.toLowerCase().includes(ve)||ke.content.toLowerCase().includes(ve)||ke.author.toLowerCase().includes(ve)||ke.tags&&ke.tags.some(we=>we.toLowerCase().includes(ve)))},S=()=>{if(!h)return[];if(!A.trim())return h.blogs;const ve=A.toLowerCase();return h.blogs.filter(ke=>ke.title.toLowerCase().includes(ve)||ke.excerpt.toLowerCase().includes(ve)||ke.content.toLowerCase().includes(ve)||ke.author.toLowerCase().includes(ve))},R=()=>{if(!h)return[];if(!A.trim())return h.events;const ve=A.toLowerCase();return h.events.filter(ke=>ke.title.toLowerCase().includes(ve)||ke.description.toLowerCase().includes(ve)||ke.venue.toLowerCase().includes(ve))};Q.useEffect(()=>{const ve=localStorage.getItem("front-theme");if(ve==="dark")r(!0),document.documentElement.classList.add("dark");else if(ve==="light")r(!1),document.documentElement.classList.remove("dark");else{const Lt=window.matchMedia("(prefers-color-scheme: dark)").matches;r(Lt),Lt?document.documentElement.classList.add("dark"):document.documentElement.classList.remove("dark")}document.title="সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ";const ke=localStorage.getItem("admin-email");if(ke){l(ke);window.ssf_current_user_email=ke;}const we=new URLSearchParams(window.location.search);let _e=we.get("tab");const Ye=we.get("newsId")||we.get("newsid"),rt=we.get("blogId")||we.get("blogid"),pt=we.get("bookId")||we.get("bookid"),Nt=we.get("circularId")||we.get("circularid")||we.get("noticeId")||we.get("noticeid"),Zt=we.get("eventId")||we.get("eventid"),Kt=we.get("mediaId")||we.get("mediaid");Ye?(u({type:"news",id:Ye}),_e="news"):rt?(u({type:"blog",id:rt}),_e="news"):pt?(u({type:"publication",id:pt}),_e="books"):Nt?(u({type:"circular",id:Nt}),_e="circulars"):Zt?(u({type:"event",id:Zt}),_e="events"):Kt&&(u({type:"media",id:Kt}),_e="media"),_e||(Ye||rt?_e="news":pt?_e="books":Nt?_e="circulars":Zt?_e="events":Kt&&(_e="media")),_e&&["home","news","books","events","circulars","about","join","portal","media","contact","press-release-creator","press-release","qa","leadership","membership","member-portal","admin"].includes(_e)&&t(_e);const An=we.get("verify-member");An&&L(An),I()},[]),Q.useEffect(()=>{const ve={home:{title:"সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"সমাজতান্ত্রিক ছাত্র ফ্রন্ট ময়মনসিংহ জেলা শাখা - সর্বজনীন গণতান্ত্রিক ও বৈজ্ঞানিক সমাজতান্ত্রিক সমাজ বিনির্মাণের লক্ষ্যে আপোষহীন প্রগতিশীল ছাত্র আন্দোলন।"},news:{title:"সংবাদ ও কলাম | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"সমাজতান্ত্রিক ছাত্র ফ্রন্ট ময়মনসিংহ জেলা শাখার সাম্প্রতিক কর্মকাণ্ড, প্রেস বিজ্ঞপ্তি, ছাত্র আন্দোলন এবং তাত্ত্বিক কলাম ও বিশ্লেষণ।"},books:{title:"শিক্ষা ও প্রকাশনা | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"মার্ক্সীয় দর্শন, পুঁজিবাদবিরোধী লড়াই, রাজনৈতিক প্রবন্ধ, বিপ্লবী ইতিহাস এবং সমাজতান্ত্রিক ছাত্র ফ্রন্টের বিভিন্ন বৈপ্লবিক ও তাত্ত্বিক প্রকাশনাসমূহ।"},events:{title:"আসন্ন ইভেন্ট ও কর্মসূচী | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"ময়মনসিংহ জেলা সংসদের কর্মী সভা, রাজনৈতিক পাঠচক্র, প্রতিবাদী সমাবেশ ও সাংস্কৃতিক অনুষ্ঠানসমূহের বিস্তারিত বিবরণ এবং অংশগ্রহণ ফরম।"},circulars:{title:"সাংগঠনিক সার্কুলার | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"সংগঠনের অভ্যন্তরীণ সিদ্ধান্ত, নির্দেশনা, দাপ্তরিক বিজ্ঞপ্তি ও সমাজতান্ত্রিক ছাত্র ফ্রন্ট ময়মনসিংহ জেলা সংসদের দাপ্তরিক সার্কুলারসমূহ।"},"press-release-creator":{title:"প্রেস রিলিজ ক্রিয়েটর | সমাজতান্ত্রিক ছাত্র ফ্রন্ট",description:"সমাজতান্ত্রিক ছাত্র ফ্রন্ট অফিসিয়াল প্রেস রিলিজ জেনারেটর ও ক্যানভাস এডিটর।"},"press-release":{title:"প্রেস রিলিজ ক্রিয়েটর | সমাজতান্ত্রিক ছাত্র ফ্রন্ট",description:"সমাজতান্ত্রিক ছাত্র ফ্রন্ট অফিসিয়াল প্রেস রিলিজ জেনারেটর ও ক্যানভাস এডিটর।"},about:{title:"আমাদের সম্পর্কে ও গঠনতন্ত্র | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"সমাজতান্ত্রিক ছাত্র ফ্রন্টের লক্ষ্য, রাজনৈতিক আদর্শ, ঐতিহাসিক রূপরেখা এবং গণতান্ত্রিক কেন্দ্রিকতা ভিত্তিক আপোষহীন সাংগঠনিক গঠনতন্ত্র।"},join:{title:"অনলাইন সদস্যপদ আবেদন ফরম | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"সমাজতান্ত্রিক ছাত্র ফ্রন্ট ময়মনসিংহ জেলা শাখার সক্রিয় কর্মী বা সহযোগী হিসেবে যুক্ত হতে অনলাইন সদস্যপদ আবেদন ফরম পূরণ করুন।"},portal:{title:"মেম্বার ও কমরেড পোর্টাল | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"সংগঠনের রেজিস্টার্ড সদস্যদের জন্য অনলাইন ড্যাশবোর্ড ও লগার, যেখানে দলীয় পরিচয়পত্র ডাউনলোড এবং কাজের রিপোর্ট তদারকি করা যায়।"},media:{title:"ফটোগ্রাফি ও মিডিয়া সেন্টার | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"ঐতিহাসিক সমাবেশ, প্রতিবাদী স্লোগান, দেয়াল লিখন ও ময়মনসিংহের ছাত্র ফ্রন্টের বিভিন্ন প্রগতিশীল রাজনৈতিক আন্দোলনের চিত্রশালা।"},contact:{title:"যোগাযোগ করুন | সমাজতান্ত্রিক ছাত্র ফ্রন্ট, ময়মনসিংহ জেলা শাখা",description:"ময়মনসিংহ জেলা কার্যালয়ের ঠিকানা, মোবাইল নম্বর এবং ইমেইল। যেকোনো তথ্য বা প্রগতিশীল জিজ্ঞাসার জন্য আমাদের সাথে সরাসরি যোগাযোগ করুন।"}},ke=ve[e]||ve.home;gd({title:ke.title,description:ke.description,type:"website",url:`${window.location.origin}${window.location.pathname}?tab=${e}`})},[e]),Q.useEffect(()=>{s?(document.documentElement.classList.add("dark"),localStorage.setItem("front-theme","dark")):(document.documentElement.classList.remove("dark"),localStorage.setItem("front-theme","light"))},[s]),Q.useEffect(()=>{"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual")},[]),Q.useEffect(()=>{const ve=()=>{const ke=new URLSearchParams(window.location.search);let we=ke.get("tab");const _e=ke.get("newsId")||ke.get("newsid"),Ye=ke.get("blogId")||ke.get("blogid"),rt=ke.get("bookId")||ke.get("bookid"),pt=ke.get("circularId")||ke.get("circularid")||ke.get("noticeId")||ke.get("noticeid"),Nt=ke.get("eventId")||ke.get("eventid"),Zt=ke.get("mediaId")||ke.get("mediaid");u(_e?{type:"news",id:_e}:Ye?{type:"blog",id:Ye}:rt?{type:"publication",id:rt}:pt?{type:"circular",id:pt}:Nt?{type:"event",id:Nt}:Zt?{type:"media",id:Zt}:null),we||(_e||Ye?we="news":rt?we="books":pt?we="circulars":Nt?we="events":Zt?we="media":we="home"),we&&["home","news","books","events","circulars","about","join","portal","media","contact","leadership","membership","member-portal","qa"].includes(we)&&t(we)};return window.addEventListener("popstate",ve),()=>{window.removeEventListener("popstate",ve)}},[]),Q.useEffect(()=>{const ve=new URLSearchParams(window.location.search),ke=ve.get("tab");if(d){ve.delete("newsId"),ve.delete("blogId"),ve.delete("bookId"),ve.delete("circularId"),ve.delete("eventId"),ve.delete("noticeId"),ve.delete("mediaId"),d.type==="news"?ve.set("newsId",d.id):d.type==="blog"?ve.set("blogId",d.id):d.type==="publication"?ve.set("bookId",d.id):d.type==="circular"?ve.set("circularId",d.id):d.type==="event"?ve.set("eventId",d.id):d.type==="media"&&ve.set("mediaId",d.id);let we=e;d.type==="news"||d.type==="blog"?we="news":d.type==="publication"?we="books":d.type==="circular"?we="circulars":d.type==="event"?we="events":d.type==="media"&&(we="media"),we!==e&&t(we),ve.set("tab",we);const _e=`?${ve.toString()}`;window.history.pushState(null,"",_e)}else{ve.delete("newsId"),ve.delete("blogId"),ve.delete("bookId"),ve.delete("circularId"),ve.delete("eventId"),ve.delete("noticeId"),ve.delete("mediaId"),ve.set("tab",e);const we=`?${ve.toString()}`;ke!==e?window.history.pushState(null,"",we):window.history.replaceState(null,"",we)}},[d,e]),Q.useEffect(()=>{const ve=()=>{window.scrollTo({top:0,left:0,behavior:"instant"})};ve();const ke=setTimeout(ve,50);return()=>clearTimeout(ke)},[e]),Q.useEffect(()=>{if(h){const ve=window.innerWidth<768?"mobile":window.innerWidth<1024?"tablet":"desktop",ke=e==="home"?"হোমপেজ":e==="news"?"নিউজ পোর্টাল":e==="books"?"শিক্ষা ও প্রকাশনা":e,we=new Date().toISOString().split("T")[0],_e=`v_${we}_${ke}_${ve}_${Date.now()}`;yn("visits",_e,{id:_e,date:we,page:ke,device:ve,views:1}).catch(Ye=>console.error("Failed to log visitor analytics",Ye))}},[e,!!h]);const I=async(ve=!1)=>{let ke=!1;try{const we=localStorage.getItem("scf_database_cache");if(we){const _e=JSON.parse(we);_e&&typeof _e=="object"&&_e.settings&&(p(_e),N(null),x(!1),ke=!0,ve=!0)}}catch(we){console.warn("Cache loading bypassed:",we)}try{!ve&&!ke&&x(!0);const we=await PH();try{localStorage.setItem("scf_database_cache",JSON.stringify(we))}catch(_e){console.warn("Failed to save database cache to localStorage:",_e)}p(we),N(null)}catch(we){console.error("Database sync and fetch failure",we),!ke&&!h&&N((we==null?void 0:we.message)||"Error communicating with cloud database.")}finally{x(!1)}},C=async ve=>{if(l(ve),localStorage.setItem("admin-email",ve),localStorage.setItem("ssf_user_email",ve),window.ssf_current_user_email=ve,window.dispatchEvent(new CustomEvent("ssf_auth_state_changed",{detail:{userEmail:ve}})),ve.toLowerCase()==="chitronbhattacharjee@gmail.com"){const ke="log_"+Date.now(),we={id:ke,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"সুপার এডমিন লগইন",user:ve,details:"চিত্তাভ ভট্টাচার্য সফলতার সাথে ড্যাশবোর্ডে লগইন করেছেন।"};try{await yn("logs",ke,we)}catch(_e){console.error(_e)}await I()}},T=async()=>{if(a){const ve="log_"+Date.now(),ke={id:ve,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"লগআউট",user:a,details:"এডমিন পোর্টাল থেকে সেশন বাতিল করা হয়েছে।"};l(null),localStorage.removeItem("admin-email"),localStorage.removeItem("ssf_user_email"),window.ssf_current_user_email=null,window.dispatchEvent(new CustomEvent("ssf_auth_state_changed",{detail:{userEmail:null}})),e==="admin"&&t("home");try{await yn("logs",ve,ke)}catch(we){console.error(we)}await I()}},B=()=>{L(null);const ve=new URL(window.location.href);ve.searchParams.delete("verify-member"),window.history.replaceState({},"",ve.pathname+ve.search)},K=ve=>{var _e;if(!ve)return;const ke=ve.replace("SSF-MYM-","").trim().toLowerCase(),we=(_e=h==null?void 0:h.memberships)==null?void 0:_e.find(Ye=>Ye.id.substring(Ye.id.length-5).toLowerCase()===ke||Ye.id.toLowerCase()===ke||Ye.mobile&&Ye.mobile.includes(ke));we?L(we.id):n.error(`দুঃখিত, '${ve}' এই মেম্বার কোডের বিপরীতে আমাদের ডাটাবেজে কোনো নিবন্ধিত সদস্য প্রোফাইল পাওয়া যায়নি।`)},he=async()=>{if(!a)return!1;try{return await DH(),await I(),!0}catch(ve){console.error(ve)}return!1},ee=async ve=>{if(!a)return!1;try{return await yn("settings","webSettings",ve),await I(),!0}catch(ke){console.error(ke)}return!1},ne=async ve=>{if(!a)return!1;try{for(const ke of ve)ke.id&&await yn("organizations",ke.id,ke);return await I(),!0}catch(ke){console.error(ke)}return!1},ie=async(ve,ke)=>{if(!a)return!1;try{const we=ve.trim().toLowerCase(),_e="invite_"+Date.now(),Ye={id:_e,email:we,role:ke||"admin",status:"pending",invitedBy:a,timestamp:new Date().toISOString().replace("T"," ").substring(0,19)};await yn("invitations",_e,Ye);const rt="log_"+Date.now(),pt={id:rt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"এডমিন নিমন্ত্রণ পাঠানো হয়েছে",user:a,details:`${we} কমরেডকে ${ke==="super_admin"?"সুপার এডমিন":"সমন্বয়ক এডমিন"} হিসেবে দায়িত্ব বা প্যানেল নিমন্ত্রণ পাঠানো হয়েছে।`};return await yn("logs",rt,pt),await I(),!0}catch(we){console.error(we)}return!1},ge=async ve=>{var ke;try{const we=(ke=h==null?void 0:h.invitations)==null?void 0:ke.find(_e=>_e.id===ve);if(we){await Xd("invitations",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"এডমিন নিমন্ত্রণ বাতিল",user:a||"unknown",details:`কমরেড ${we.email}-এর এডমিন নিমন্ত্রণটি প্যানেল থেকে সফলভাবে বাতিল করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}}catch(we){console.error(we)}return!1},ae=async(ve,ke)=>{var we;try{const _e=(we=h==null?void 0:h.invitations)==null?void 0:we.find(Ye=>Ye.id===ve);if(_e){const Ye={..._e,status:ke};await yn("invitations",ve,Ye);const rt="log_"+Date.now(),pt={id:rt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:`নিমন্ত্রণ ${ke==="accepted"?"অনুমোদিত":"প্রত্যাখ্যাত"}`,user:a||_e.email,details:`কমরেড ${_e.email} এডমিন নিমন্ত্রণ ${ke==="accepted"?"সরাসরি গ্রহণ করে পূর্ণ এডমিন প্যানেল এক্সেস সেশন চালু করেছেন।":"প্রত্যাখ্যান করেছেন।"}`};return await yn("logs",rt,pt),await I(),!0}}catch(_e){console.error(_e)}return!1},W=async ve=>{if(!a)return!1;try{const ke="news_"+Date.now(),we={...ve,id:ke,views:0,date:new Date().toISOString().split("T")[0]};await yn("news",ke,we);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"নিউজ তৈরি",user:a,details:`"${ve.title}" শিরোনামে খবর প্রকাশিত করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(ke){console.error(ke)}return!1},V=async(ve,ke)=>{var we;if(!a)return!1;try{const Ye={...(we=h==null?void 0:h.news)==null?void 0:we.find(Nt=>Nt.id===ve),...ke,id:ve};await yn("news",ve,Ye);const rt="log_"+Date.now(),pt={id:rt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"নিউজ সম্পাদিত",user:a,details:`"${Ye.title}" শিরোনামের খবর এডিট বা আপডেট করা হয়েছে।`};return await yn("logs",rt,pt),await I(),!0}catch(_e){console.error(_e)}return!1},$=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.news)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("news",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"নিউজ অপসারিত",user:a,details:`"${(we==null?void 0:we.title)||ve}" খবরটি ডেটাবেজ থেকে মুছে দেওয়া হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},te=async ve=>{if(!a)return!1;try{const ke="blog_"+Date.now(),we={...ve,id:ke,views:0,comments:[],date:new Date().toISOString().split("T")[0]};await yn("blogs",ke,we);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"ব্লগ তৈরি",user:a,details:`"${ve.title}" প্রগতিশীল প্রবন্ধটি সফলভাবে প্রকাশ করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(ke){console.error(ke)}return!1},ue=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.blogs)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("blogs",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"ব্লগ অপসারিত",user:a,details:`"${(we==null?void 0:we.title)||ve}" নিবন্ধটি মুছে দেওয়া হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},pe=async(ve,ke)=>{if(!a)return!1;try{await yn("blogs",ve,ke);const we="log_"+Date.now(),_e={id:we,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"ব্লগ আপডেট/অনুমোদন",user:a,details:`"${ke.title}" নিবন্ধটির স্থিতি আপডেট করা হয়েছে।`};return await yn("logs",we,_e),await I(),!0}catch(we){console.error(we)}return!1},be=async(ve,ke,we,_e)=>{var Ye,rt;try{const pt=(Ye=h==null?void 0:h.blogs)==null?void 0:Ye.find(An=>An.id===ve);if(!pt)return null;const Nt={id:"comment_"+Date.now(),authorName:ke,authorEmail:we,text:_e,date:new Date().toISOString().split("T")[0],approved:we.toLowerCase()==="chitronbhattacharjee@gmail.com"||((rt=h.invitations)==null?void 0:rt.some(An=>An.email.toLowerCase()===we.toLowerCase()&&An.status==="accepted"))},Zt=[...pt.comments||[],Nt],Kt={...pt,comments:Zt};return await yn("blogs",ve,Kt),await I(),Nt}catch(pt){console.error(pt)}return null},Re=async(ve,ke)=>{var we;if(!a)return!1;try{const _e=(we=h==null?void 0:h.blogs)==null?void 0:we.find(pt=>pt.id===ve);if(!_e)return!1;const Ye=(_e.comments||[]).map(pt=>pt.id===ke?{...pt,approved:!0}:pt),rt={..._e,comments:Ye};return await yn("blogs",ve,rt),await I(),!0}catch(_e){console.error(_e)}return!1},Le=async ve=>{if(!a)return!1;try{const ke="event_"+Date.now(),we={...ve,id:ke,registrants:[],status:"upcoming"};await yn("events",ke,we);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"ইভেন্ট তৈরি",user:a,details:`"${ve.title}" ইভেন্টটি যুক্ত করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(ke){console.error(ke)}return!1},$e=async(ve,ke)=>{var we;try{const _e=(we=h==null?void 0:h.events)==null?void 0:we.find(Nt=>Nt.id===ve);if(!_e)return null;const Ye={id:"reg_"+Date.now(),...ke,appliedAt:new Date().toISOString().replace("T"," ").substring(0,19)},rt=[..._e.registrants||[],Ye],pt={..._e,registrants:rt};return await yn("events",ve,pt),await I(),Ye}catch(_e){console.error(_e)}return null},ct=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.events)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("events",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"ইভেন্ট অপসারিত",user:a,details:`"${(we==null?void 0:we.title)||ve}" ইভেন্ট মুছে ফেলা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},dt=async(ve,ke)=>{var we;if(!a)return!1;try{const Ye={...(we=h==null?void 0:h.events)==null?void 0:we.find(Nt=>Nt.id===ve),...ke,id:ve};await yn("events",ve,Ye);const rt="log_"+Date.now(),pt={id:rt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"ইভেন্ট সম্পাদিত",user:a,details:`"${Ye.title}" ইভেন্টটি আপডেট বা এডিট করা হয়েছে।`};return await yn("logs",rt,pt),await I(),!0}catch(_e){console.error(_e)}return!1},St=async ve=>{if(!a)return!1;try{const ke="book_"+Date.now(),we={...ve,id:ke,downloadCount:0,date:new Date().toISOString().split("T")[0]};await yn("books",ke,we);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"প্রকাশনা সংগ্রহশালায় বই সংযুক্ত",user:a,details:`"${ve.title}" পুস্তিকা প্রকাশনা লাইব্রেরিতে সংযোজন করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(ke){console.error(ke)}return!1},nt=async ve=>{var ke;try{const we=(ke=h==null?void 0:h.books)==null?void 0:ke.find(Ye=>Ye.id===ve);if(!we)return!1;const _e={...we,downloadCount:(we.downloadCount||0)+1};return await yn("books",ve,_e),await I(),!0}catch(we){console.error(we)}return!1},ce=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.books)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("books",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"প্রকাশনা অপসারিত",user:a,details:`"${(we==null?void 0:we.title)||ve}" প্রকাশনাটি মুছে ফেলা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},xt=async ve=>{if(!a)return!1;try{const ke="circ_"+Date.now(),we={...ve,id:ke,date:new Date().toISOString().split("T")[0]};await yn("circulars",ke,we);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"সাংগঠনিক সার্কুলার প্রকাশ",user:a,details:`"${ve.title}" শিরোনামে সাংগঠনিক সার্কুলার জারি করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(ke){console.error(ke)}return!1},en=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.circulars)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("circulars",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"সার্কুলার অপসারিত",user:a,details:`"${(we==null?void 0:we.title)||ve}" বিজ্ঞপ্তি বা সার্কুলার মুছে ফেলা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},Ct=async(ve,ke)=>{var we;if(!a)return!1;try{const Ye={...(we=h==null?void 0:h.books)==null?void 0:we.find(Nt=>Nt.id===ve),...ke,id:ve};await yn("books",ve,Ye);const rt="log_"+Date.now(),pt={id:rt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"প্রকাশনা সম্পাদিত",user:a,details:`"${Ye.title}" বইটি মডিফাই করা হয়েছে।`};return await yn("logs",rt,pt),await I(),!0}catch(_e){console.error(_e)}return!1},Je=async(ve,ke)=>{var we;if(!a)return!1;try{const Ye={...(we=h==null?void 0:h.circulars)==null?void 0:we.find(Nt=>Nt.id===ve),...ke,id:ve};await yn("circulars",ve,Ye);const rt="log_"+Date.now(),pt={id:rt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"সার্কুলার সম্পাদিত",user:a,details:`"${Ye.title}" সার্কুলার সংশোধন করা হয়েছে।`};return await yn("logs",rt,pt),await I(),!0}catch(_e){console.error(_e)}return!1},At=async ve=>{if(!a)return!1;try{const ke="gallery_"+Date.now(),we={...ve,id:ke,date:new Date().toISOString().split("T")[0]};await yn("gallery",ke,we);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"মিডিয়া গ্যালারি সংযুক্তি",user:a,details:`"${ve.title}" অ্যালবাম ছবি বা ইনফোগ্রাফিক গ্যালারিতে সংযোজন করা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(ke){console.error(ke)}return!1},Rt=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.gallery)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("gallery",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"মিডিয়া গ্যালারি চিত্র অপসারিত",user:a,details:`"${(we==null?void 0:we.title)||ve}" ফাইলটি গ্যালারি থেকে মুছে ফেলা হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},Ut=async(ve,ke)=>{if(!a)return!1;try{await yn("gallery",ve,{...ke,id:ve});const we="log_"+Date.now(),_e={id:we,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"মিডিয়া গ্যালারি আপডেট",user:a,details:`"${ke.title}" গ্যালারি কন্টেন্টটির তথ্য/ক্যাটাগরি আপডেট করা হয়েছে।`};return await yn("logs",we,_e),await I(),!0}catch(we){console.error(we)}return!1},ft=async ve=>{try{const ke="member_"+Date.now(),we={...ve,id:ke,status:"pending",appliedAt:new Date().toISOString().replace("T"," ").substring(0,19)};return await yn("memberships",ke,we),await I(),we}catch(ke){console.error(ke)}return null},Et=async(ve,ke)=>{var we;if(!a)return!1;try{const _e=(we=h==null?void 0:h.memberships)==null?void 0:we.find(Ye=>Ye.id===ve);if(_e){const Ye=new Date().toISOString().replace("T"," ").substring(0,19),rt={timestamp:Ye,editedBy:a,field:"সদস্যপদ অবস্থা / Membership Approval Status",oldValue:_e.status||"pending",newValue:ke==="verified"?"অনুমোদিত ও সক্রিয় (Verified)":"প্রত্যাখ্যাত ও নিষ্ক্রিয় (Rejected)"},pt={..._e,status:ke,verifiedAt:Ye,editHistory:[..._e.editHistory||[],rt]};await yn("memberships",ve,pt);const Nt="log_"+Date.now(),Zt={id:Nt,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"সদস্য আবেদন যাচাই",user:a,details:`${_e.name} কমরেডের মেম্বারশিপ আবেদন ${ke==="verified"?"অনুমোদিত":"প্রত্যাখ্যাত"} করা হয়েছে।`};return await yn("logs",Nt,Zt),await I(),!0}}catch(_e){console.error(_e)}return!1},Me=async ve=>{var ke;if(!a)return!1;try{const we=(ke=h==null?void 0:h.memberships)==null?void 0:ke.find(rt=>rt.id===ve);await Xd("memberships",ve);const _e="log_"+Date.now(),Ye={id:_e,timestamp:new Date().toISOString().replace("T"," ").substring(0,19),action:"সদস্য পদ বাতিল/অপসারণ",user:a,details:`${(we==null?void 0:we.name)||ve} কমরেডের তথ্য ডাটাবেজ থেকে মুছে দেওয়া হয়েছে।`};return await yn("logs",_e,Ye),await I(),!0}catch(we){console.error(we)}return!1},tt=async ve=>{try{return await yn("memberships",ve.id,ve),await I(),!0}catch(ke){console.error("Error updating member profile in App.tsx:",ke)}return!1},Gt=()=>{var we;if(!h)return null;const ve=h.settings,ke=!!((we=h.memberships)!=null&&we.some(_e=>{var Ye;return((Ye=_e.email)==null?void 0:Ye.toLowerCase())===(a==null?void 0:a.toLowerCase())&&_e.status==="verified"}));if(d)return i.jsx(WQ,{item:d,db:h,onClose:()=>u(null),onRefresh:()=>I(!0),userEmail:a,onSelectItem:(_e,Ye)=>u({type:_e,id:Ye}),isVerifiedMember:ke});switch(e){case"home":return i.jsx(h_,{news:U(),blogs:S(),circulars:h.circulars,events:R(),setCurrentTab:t,aboutText:ve.aboutText,slogans:ve.slogans,onSelectItem:(_e,Ye)=>u({type:_e,id:Ye})});case"qa":setTimeout(()=>window.JC_setTab&&window.JC_setTab("qa-list"), 50);return i.jsx("div",{id:"qa-react-root",className:"min-h-[70vh] w-full max-w-7xl mx-auto"});case"about":return i.jsx(UH,{settings:ve,organizations:h.organizations||[]});case"leadership":return i.jsx(VH,{settings:ve,onViewMemberProfile:K});case"news":return i.jsx(qH,{news:h.news,blogs:h.blogs,onAddComment:be,userEmail:a,onRefresh:()=>I(!0),globalSearchQuery:A,setGlobalSearchQuery:E,onSelectItem:(_e,Ye)=>u({type:_e,id:Ye})});case"events":return ve.showEvents?i.jsx($H,{events:R(),onRegisterEvent:$e,onSelectItem:(_e,Ye)=>u({type:_e,id:Ye})}):i.jsx("div",{className:"py-16 text-center text-zinc-500 text-xs sm:text-sm",children:"এই সেকশনটি এডমিন কর্তৃক হাইড করা আছে।"});case"books":return ve.showPublications?i.jsx(HH,{books:h.books,onDownloadBook:nt,isVerifiedMember:ke,onSelectItem:(_e,Ye)=>u({type:_e,id:Ye})}):i.jsx("div",{className:"py-16 text-center text-zinc-500 text-xs sm:text-sm",children:"প্রকাশনা সেকশনটি সাময়িকভাবে নিষ্ক্রিয় করা আছে।"});case"circulars":{const isAdm=(a&&a.trim().toLowerCase()==="chitronbhattacharjee@gmail.com")||((h&&h.invitations)||[]).some(inv=>inv.email&&inv.email.toLowerCase()===(a||"").trim().toLowerCase()&&inv.status==="accepted");return ve.showCirculars?i.jsx(GH,{circulars:h.circulars,isVerifiedMember:ke,onSelectItem:(_e,Ye)=>u({type:_e,id:Ye}),isAdmin:isAdm,onOpenPressReleaseCreator:()=>{u(null);t("press-release-creator")}}):i.jsx("div",{className:"py-16 text-center text-zinc-500 text-xs sm:text-sm",children:"সার্কুলার বোর্ড সাময়িকভাবে নিষ্ক্রিয় করা আছে।"})};