...
function GH({ circulars: n = [], isVerifiedMember: e = false, isApprovedMember: isApproved = false, onSelectItem: t, isAdmin: lAdmin = false, onOpenPressReleaseCreator: lOpenPR = null, userEmail = "" }) {
  const toast = Nm();
                ...
                i.jsx(Na, {
                  children: isExpanded && i.jsx($r.div, {
                    ...
                    children: i.jsx("div", {
                      ...
                      children: isMemberLocked ? (
                        // Not logged in member / pending verification prompt
                        isApproved ? (
                          i.jsxs("div", {
                            className: "bg-amber-500/10 dark:bg-amber-950/40 border border-amber-500/30 rounded p-6 text-center space-y-4 font-sans",
                            children: [
                              i.jsx(ch, { className: "w-10 h-10 text-amber-500 mx-auto animate-bounce" }),
                              i.jsxs("div", {
                                className: "max-w-md mx-auto space-y-2",
                                children: [
                                  i.jsx("h4", {
                                    className: "text-sm font-bold text-amber-900 dark:text-amber-200",
                                    children: "মেম্বারশিপ ভেরিফিকেশন অপেক্ষারত (Verification Pending)"
                                  }),
                                  i.jsx("p", {
                                    className: "text-xs text-amber-800 dark:text-amber-300 leading-relaxed",
                                    children: "আপনার মেম্বারশিপ অনুমোদিত হলেও এখনও এডমিন কর্তৃক ভেরিফাইড (Verified Member) হয়নি। সার্কুলারটি দেখতে এডমিন ভেরিফিকেশনের অপেক্ষা করুন।"
                                  })
                                ]
                              }),
                              i.jsxs("div", {
                              ...
                              i.jsxs("div", {
                                ...
                                children: [
                                  ...
                                  i.jsx("p", {
                                    ...
                                    children: 'এটি ময়মনসিংহ জেলা সংসদের একটি অভ্যন্তরীণ সাংগঠনিক বিবরণী বা সদস্যদের জন্য বিশেষ নোটিশ। প্রকাশনা ও নির্দেশিকার গোপনীয়তা বজায় রাখার স্বার্থে এর অ্যাক্সেস ব্লক রয়েছে। অ্যাক্সেস পেতে দয়া করে "মেম্বার পোর্টাল" ট্যাবে গিয়ে নিবন্ধিত ইমেইল দ্বারা লগইন করুন।'
                                  })
                                ]
                              }),
                              i.jsxs("div", {
